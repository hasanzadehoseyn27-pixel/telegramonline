...
_WHITELIST: list[tuple[str, list[list[str]], list[str]]] = [
    ...
    # اگه صریحاً «رانا معمولی» یا مدل قبل ۱۴۰۰ بود (بدون کاسه/پانا)، همون
    # «رانا دیسک» حساب می‌شه — دسته‌ی جدا نمی‌خوایم.
    ("rana_disk", [["رانا"], ["معمولی", "1390", "1391", "1392", "1393", "1394", "1395", "1396", "1397", "1398", "1399"]], ["پانا", "پاناروما", "پانوراما", "کاسه"]),
    ...
    # ── دنا ۶ سرعته ──
    ("dena_6speed", [["دنا"], ["6 سرعته", "۶ سرعته", "6 دنده", "۶ دنده"]], []),

    # ── دنا اتومات آپشنال ──
    ("dena_automatic_optional", [["دنا"], ["اتومات"], ["آپشنال"]], []),

    # ── پژو ۲۰۷ ──
    ("peugeot207_pana_gear_rim", [["207"], ["پانا"], ["دنده"], ["رینگ"]], []),
    ("peugeot207_pana_gear_ghalpagh", [["207"], ["پانا"], ["دنده"], ["قالپاق"]], []),
    ("peugeot207_pana_automatic", [["207"], ["پانا"], ["اتومات"]], []),
    ("peugeot207_metal_automatic", [["207"], ["فلز"], ["اتومات"]], []),
    ("peugeot207_metal_gear_hydraulic", [["207"], ["فلز"], ["دنده"], ["هیدرولیک"]], []),
    ("peugeot207_metal_gear_electric_full", [["207"], ["فلز"], ["دنده"], ["فول برقی", "فول‌برقی", "برقی فول"]], []),
    ("peugeot207_tu3", [["207"], ["tu3", "تی یو تری", "تی یو تیری"]], []),

    # ── هایما ──
    ("haima_s8", [["هایما"], ["s8", "اس8", "اس 8", "اس هشت"]], []),
    ("haima_s7", [["هایما"], ["s7", "اس7", "اس 7", "اس هفت"]], []),
    ("haima_s5", [["هایما"], ["s5", "اس5", "اس 5", "اس پنج"]], []),
    ("haima_x7", [["هایما"], ["x7", "ایکس7", "ایکس 7", "ایکس هفت"]], []),

    # ── ریرا (سردنده جدید باید قبل از معمولی چک بشه) ──
    ("rira_new_gearhead", [["ریرا", "ری را"], ["سردنده جدید", "سر دنده جدید"]], []),
    ("rira_normal", [["ریرا", "ری را"]], ["سردنده جدید", "سر دنده جدید"]),

    # ── شاهین ──
    ("shahin_automatic_cvt", [["شاهین"], ["اتومات"], ["cvt"]], []),
    ("shahin_plus_automatic_tu5", [["شاهین"], ["پلاس"], ["اتومات"], ["tu5"]], []),
    ("shahin_gear_sunroof", [["شاهین"], ["دنده"], ["سانروف"]], []),
    ("shahin_gear_no_sunroof", [["شاهین"], ["دنده"]], ["سانروف"]),

    # ── ساینا ──
    ("saina_dogane", [["ساینا"], ["دوگانه"]], []),
    ("saina_normal", [["ساینا"]], ["دوگانه"]),

    # ── اطلس ──
    ("atlas_gear", [["اطلس"], ["دنده"]], []),
    ("atlas_automatic", [["اطلس"], ["اتومات"]], []),

    # ── کوییک ──
    ("quick_s", [["کوییک", "کوئیک"], ["s"]], []),
    ("quick_rs", [["کوییک", "کوئیک"], ["rs"]], []),
    ("quick_gxr", [["کوییک", "کوئیک"], ["gxr"]], []),
    ("quick_gx", [["کوییک", "کوئیک"], ["gx"]], []),
    ("quick_automatic", [["کوییک", "کوئیک"], ["اتومات"]], []),

    # ── پراید وانت ──
    ("pride_pickup", [["پراید"], ["وانت"]], []),

    # ── آریسان ۲ ──
    ("arisan2", [["آریسان"], ["2", "۲", "دو"]], []),
]
