...
export default function DashboardLayout({ children }: Props) {
  ...
  return (
    ...
    >
      ...
      <main className="relative mr-64 h-screen overflow-hidden pt-14 max-lg:mr-0 max-lg:pb-24 max-sm:pt-12">
        <div className="h-full overflow-hidden px-3 py-1 sm:px-4 lg:px-7">{children}</div>
      </main>
    </div>
  );
}
